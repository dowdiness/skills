...
export const skills: SkillMeta[] = [
  ...
  { name: 'moonbit-housekeeping', kind: 'vendor', source: 'https://github.com/dowdiness/moonbit-skills', vendorPath: 'vendor/dowdiness/moonbit-skills', sourceSkillPath: 'vendor/dowdiness/moonbit-skills/moonbit-housekeeping/SKILL.md', outputPath: 'skills/moonbit-housekeeping/SKILL.md', notes: 'Includes BAML schemas and parser fixtures for worker-output intake.' },
